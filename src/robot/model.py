...
class RobotModel:
    ...
    def __init__(
        ...
        joint_limits: List[JointLimits] = None
    ) -> None:
        """
        ...
        if len(link_lengths) != 3:
            raise ValueError("RobotModel requires exactly 3 link lengths.")
        ...
        if joint_limits is None:
            ...
            if len(joint_limits) != 3:
                raise ValueError("RobotModel requires exactly 3 joint limits.")
